                ...
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $users->alamat }}</td>
                            <td>
                                <a href="#" data-toggle="modal" data-target="#editDataKiloan{{ $users->id }}"><img class="btn-table gambar-table" src="assets/img/image/edit.png" style="width: 35px;"></a>
                        ...
                        <form action="/data_kasir/{{ $users->slug }}" method="post">
                            @method('put')
                            @csrf
                            <div class="modal fade" id="editDataKiloan{{ $users->id }}" tabindex="-1" role="dialog" aria-labelledby="editDataKiloan" aria-hidden="true">
                                                        ...
                                                        <form class="col-6" action="/register" method="post">
                                                            ...
                                                            <div class="col-pelanggan d-flex mb-2">
                                                                ...
                                                                <div class="form-check" name="gender">
                                                                    ...
                                                                    <input class="form-check-input" type="radio" name="gender" value="gender" id="gender1" checked>
                                                                    <label class="form-check-label text-black-100 small" for="gender1">
                                                                        Laki-Laki
                                                                    </label>
                                                                    @else
                                                                    <input class="form-check-input" type="radio" name="gender" value="gender" id="gender1">
                                                                    <label class="form-check-label text-black-100 small" for="gender1">
                                                                        Laki-Laki
                                                                    </label>
                                                                    @endif
                                                                ...
                                                                <div class="form-check ml-2" name="gender">
                                                                    ...
                                                                    <input class="form-check-input" type="radio" name="gender" value="gender" id="gender2" checked>
                                                                    <label class="form-check-label text-black-100 small" for="id=" gender2>
                                                                        Perempuan
                                                                    </label>
                                                                    @else
                                                                    <input class="form-check-input" type="radio" name="gender" value="gender" id="gender2">
                                                                    <label class="form-check-label text-black-100 small" for="id=" gender2>
                                                                        Perempuan
                                                                    </label>
                                                                    @endif
                                                            ...
                                                            <div class="form-group col-pelanggan">
                                                                <textarea class="form-control col-pelanggan @error('alamat') is-invalid @enderror" name="alamat" id="alamat" rows="3" required value="{{ old('alamat', $users->alamat) }}"></textarea>
                                                                @error('alamat')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                            ...
                                                            <div class="row col-pelanggan d-flex justify-content-between align-item-center">
                                                                ...
                                                                <div class="form-group col-5 text-right mr-n4">
                                                                    <a class="btn btn-success" href="{{ "update/".$users['id'] }}">Input</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
